    ...
    try {
        ...
        const templates = {
            calm: {
                ...
                tips: ["Take a deep breath before speaking", "Speak slowly and clearly", "Maintain friendly eye contact"],
                bodyLanguageTips: ["Keep your hands relaxed at your sides", "Stand with open posture", "Nod occasionally to show you're engaged"],
                doNot: ["Don't raise your voice", "Don't point fingers", "Don't make it personal"]
            },
            assertive: {
                ...
                tips: ["Be direct and clear", "State facts, not emotions", "Ask for specific actions"],
                bodyLanguageTips: ["Stand tall and confident", "Make direct eye contact", "Use measured hand gestures"],
                doNot: ["Don't be aggressive", "Don't interrupt", "Don't make threats"]
            },
            friendly: {
                ...
                tips: ["Smile genuinely", "Use a warm tone", "Acknowledge their effort"],
                bodyLanguageTips: ["Lean in slightly to show interest", "Use open, welcoming gestures", "Mirror their positive expressions"],
                doNot: ["Don't be sarcastic", "Don't minimize the issue", "Don't be overly apologetic"]
            },
            firm: {
                ...
                tips: ["Be clear about your expectations", "Don't back down on valid concerns", "Stay professional throughout"],
                bodyLanguageTips: ["Maintain steady eye contact", "Keep your posture strong but not aggressive", "Speak with a steady, controlled voice"],
                doNot: ["Don't lose your temper", "Don't make ultimatums", "Don't get personal"]
            }
        };
        ...
        const generatedScript = {
            situation: situation,
            tone: tone,
            openingLine: `${template.openingPrefix} ${situation.toLowerCase()}.`,
            ...
            quickReminders: ["🧘 Take a breath first", "👀 Make friendly eye contact", "🗣️ Speak slowly and clearly", "🤝 Stay respectful throughout"]
        };
